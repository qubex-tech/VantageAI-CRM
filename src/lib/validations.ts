...
const insurancePolicyFormSchemaBase = z.object({
  ...
  clearinghousePayerId: z.string().optional(),
})
...
export const outboundAgentsSettingsSchema = z.object({
  ...
  outreachChannel: z.enum(['sms', 'voice', 'prefer_sms', 'prefer_voice', 'curogram_sms']).optional(),
  smsTemplateName: z.string().optional(),
  curogramSmsTemplateName: z.string().optional(),
