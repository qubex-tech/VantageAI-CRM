...
function getVariableFallback(varKey: string): string {
  ...
  const fallbacks: Record<string, string> = {
    ...
    'appointment.time': '',
    'appointment.currentDate': 'your current appointment',
    'appointment.currentTime': '',
    'currentAppointment.date': 'your current appointment date',
    'currentAppointment.time': 'your current appointment time',
    'currentAppointment.dateTime': 'your current appointment',
    'currentAppointment.visitType': 'your visit type',
    'appointment.location': '',
    'appointment.providerName': 'your provider',
    'offeredSlot.date': 'the offered date',
    'offeredSlot.time': 'the offered time',
    'offeredSlot.dateTime': 'the offered time',
    'offeredSlot.visitType': 'appointment',
    'links.confirm': '#',
    'links.reschedule': '#',
    'links.cancel': '#',
