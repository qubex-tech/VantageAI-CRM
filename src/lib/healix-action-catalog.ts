...
export const HEALIX_ACTION_CATALOG: HealixActionCatalogEntry[] = [
  {
    ...
    toolName: 'createTask',
    requiredArgs: ['patientId|patientName|appointmentId', 'title'],
  ...
  },
  {
    ...
    toolName: 'createNote',
    requiredArgs: ['patientId|patientName|appointmentId', 'content'],
  ...
  },
  {
    ...
    requiredArgs: ['patientId|patientName', 'channel', 'content'],
  ...
  },
  {
    ...
    requiredArgs: ['patientId|patientName', 'patch'],
  ...
  },
  {
    ...
    requiredArgs: ['patientId|patientName', 'channel'],
  ...
  },
  {
    ...
    requiredArgs: ['patientId|patientName', 'formTemplateId'],
  ...
  },
  {
    ...
    toolName: 'listAppointmentTypes',
    requiredArgs: [],
    example: 'Show me available appointment types.',
    executable: true,
  },
  {
    id: 'get-appointment-slots',
    label: 'Get appointment slots',
    description: 'Find available slots for a visit type and date range.',
    toolName: 'getAppointmentSlots',
    requiredArgs: ['eventTypeId|visitTypeName', 'dateFrom', 'dateTo', 'timezone'],
    example: 'Find slots for a follow-up next week.',
    executable: true,
  },
  {
    id: 'book-appointment',
    label: 'Book appointment',
    description: 'Book a selected slot for a patient.',
    toolName: 'bookAppointment',
    requiredArgs: ['patientId|patientName', 'eventTypeId|visitTypeName', 'startTime', 'timezone'],
    example: 'Book the 10:00 AM slot for the patient.',
    executable: true,
  },
  {
    id: 'schedule-appointment',
    label: 'Schedule appointment',
    description: 'Guide scheduling by listing appointment types, fetching slots, and booking.',
