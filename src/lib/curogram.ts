...
export type CurogramMappingIdSource = 'mrn' | 'mrn_fetched' | 'blank'

/**
 * eCW secondary account / MRN only. If none exists, mappingId is blank.
 * Never send FHIR Patient.id or CRM UUID.
 */
