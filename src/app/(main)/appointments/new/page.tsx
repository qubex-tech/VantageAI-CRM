...
export default async function NewAppointmentPage({
  ...
  return (
    <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8 md:pt-8 max-w-2xl">
      <Card className="border border-gray-200 shadow-sm">
        <CardHeader className="pb-3">
          <CardTitle className="text-xl font-semibold text-gray-900">Schedule Appointment</CardTitle>
          <CardDescription className="text-sm text-gray-500">Book a new appointment</CardDescription>
        </CardHeader>
        <CardContent>
