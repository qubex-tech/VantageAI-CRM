...
/**
 * Client component for Patient Portal auth.
 * Must be rendered within a <Suspense> boundary (Next.js requirement for useSearchParams()).
 */
        ...
        <CardContent>
          ...
          {step === 'request' ? (
            <form onSubmit={handleRequestOTP} className="space-y-4">
              ...
              <p className="text-xs text-gray-500">
                Please provide your full name and either email or phone number. This helps us identify you if you share
                contact information with family members.
              </p>
